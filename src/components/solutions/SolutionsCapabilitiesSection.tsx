  ...
  return (
    ...
    >
      <div className="section-container">
        ...
        {/* Círculos que se muestran más arriba en la página - redistribuidos y centrados */}
        <div 
        ...
        >
          {/* Contenedor centrado para los círculos */}
          <div className="relative w-full flex items-center justify-center" style={{ height: "100%" }}>
            ...
            {/* Círculos de práctica - regresar al funcionamiento original pero centrado */}
